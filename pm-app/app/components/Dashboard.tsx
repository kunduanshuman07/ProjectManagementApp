                ...
                <div className='flex flex -row mt-5 ml-10'>
                    ...
                    <div className="stats shadow ml-5">
                        ...
                        <div className="stat place-items-center">
                            ...
                            <div className="stat-value mt-3 text-success">{loading?<span className="loading loading-dots loading-md"></span>:dashboardData.DoneCount} </div>
                        </div>
                    </div>
                    <div className="stats shadow ml-5">
                        <div className="stat place-items-center">
                        ...
                        <div className="stat place-items-center">
                            ...
                            <div className="stat-value mt-3 text-warning">{loading?<span className="loading loading-dots loading-md"></span>:dashboardData.MedCount} </div>
                        </div>
                        <div className="stat place-items-center">
                            <div className="stat-title font-bold">Low Priority</div>
                            <div className="stat-value mt-3 text-accent">{loading?<span className="loading loading-dots loading-md"></span>:dashboardData.LowCount} </div>
                        </div>
                    </div>
                    <div className="stats shadow ml-5">
                        <div className="stat place-items-center">
                            ...
                            <div className="stat-desc mt-3 text-neutral font-bold">{loading?<span className="loading loading-dots loading-md"></span>:`Deadline: ${dashboardData.ClosestProject.deadline}`}</div>
                        </div>
                    </div>
                </div>
            </div>
